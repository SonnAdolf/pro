...
public:
	CPro();
	CPro(float writing_pro, float art_learning_pro, float reading_pro, float computer_learning_pro, std::wstring note);
	CPro(std::wstring writing_pro, std::wstring art_learning_pro, std::wstring reading_pro, std::wstring computer_pro, std::wstring note);
	...
	std::wstring get_computer_learning_pro_str();
...
private:
	...
	std::wstring m_computer_learning_pro_str;
